...
class RobotPoseToWorld:
    def __init__(self):
        ...
        # Pose tag word
        TagPx = rospy.get_param('~TagPx', 0.2)
        TagPy = rospy.get_param('~TagPy', 0.3)
        TagPz = rospy.get_param('~TagPz', 0.8)
        TagRoll = rospy.get_param('~TagRoll', 0.5)
        TagPitch = rospy.get_param('~TagPitch', 1.57)
        TagYaw = rospy.get_param('~TagYaw', -0.7)
        print(TagRoll)
        print(TagPitch)
        print(TagYaw)
